...
export const productSchemaStore = z.object({
  ...
  discount_value: z.coerce.number({ required_error: "Discount must be an integer" })
    .min(0, "Discount must be at least 0")
    .optional(),
    
  final_price: z.coerce.number({ required_error: "Final Price must be an integer" })
