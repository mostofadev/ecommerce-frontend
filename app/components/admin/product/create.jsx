...
export default function ProductForm() {
  ...
  const onSubmit = async (data) => {
    ...
    data.variants.forEach((v, i) =>
      Object.entries(v).forEach(([k, vVal]) =>
  ...
  return (
    <FormProvider {...methods}>
      <FormWrapper
        ...
        className="max-w-4xl mx-auto p-8 bg-white rounded shadow space-y-6"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <TextInput
            ...
            name="original_price"
            error={
              errors.original_price?.message || serverError?.original_price
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div
            style={{
              display: discountType !== "percentage" ? "none" : "block",
            }}
          >
            <TextInput
              label="Discount Value"
